...
declare type BuiltInTypes = boolean | boolean | string | string[] | Record<string, unknown> | number | Date | RegExp | bigint | symbol | null | undefined | never;
/**
 ...
 */
declare type FilterFieldComparisonType<FieldType, IsKeys extends true | false> = FieldType extends string | String ? StringFieldComparisons : FieldType extends boolean | Boolean ? BooleanFieldComparisons : FieldType extends null | undefined | never ? BooleanFieldComparisons : FieldType extends number | Date | RegExp | bigint | BuiltInTypes[] | any[] | symbol ? CommonFieldComparisonType<FieldType> : FieldType extends Array<infer U> ? CommonFieldComparisonType<U> | Filter<U> : IsKeys extends true ? CommonFieldComparisonType<FieldType> & StringFieldComparisons & Filter<FieldType> : CommonFieldComparisonType<FieldType> | Filter<FieldType>;
/**
 * Type for field comparisons.
 *
 * * `string` - [[StringFieldComparisons]]
