...
const PageInfoType = () => {
    ...
    tslib_1.__decorate([
        graphql_1.Field(() => Boolean, { nullable: true, description: 'true if paging forward and there are more records.' }),
        tslib_1.__metadata("design:type", Boolean)
    ], PageInfoTypeImpl.prototype, "hasNextPage", void 0);
    tslib_1.__decorate([
        graphql_1.Field(() => Boolean, { nullable: true, description: 'true if paging backwards and there are more records.' }),
        tslib_1.__metadata("design:type", Boolean)
    ], PageInfoTypeImpl.prototype, "hasPreviousPage", void 0);
    tslib_1.__decorate([
        graphql_1.Field(() => cursor_scalar_1.ConnectionCursorScalar, { nullable: true, description: 'The cursor of the first returned record.' }),
    ...
    PageInfoTypeImpl = tslib_1.__decorate([
        graphql_1.ObjectType('PageInfo'),
        tslib_1.__metadata("design:paramtypes", [Boolean, Boolean, Object, Object])
    ], PageInfoTypeImpl);
