...
describe('createTypegooseQueryServiceProviders', () => {
    it('should create a provider for the entity', () => {
        ...
        const providers = providers_1.createMongooseQueryServiceProviders([
        ...
        expect(providers[0].useFactory(ts_mockito_1.instance(() => { }))).toBeInstanceOf(services_1.MongooseQueryService);
    });
});
