...
export declare function isReferenceOptions(options: any): options is ReferenceOptions;
...
export declare function isVirtualReferenceOptions(options: any): options is VirtualReferenceOptions;
