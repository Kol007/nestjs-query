...
describe('@Assembler', () => {
    it('should register an assembler with metadata', () => {
        ...
        TestAssembler = tslib_1.__decorate([
            src_1.Assembler(TestFrom, TestTo)
        ], TestAssembler);
    ...
    it('should throw an error when registering an assembler for the same From To combo', () => {
        ...
        expect(() => src_1.Assembler(TestFrom, TestTo)(TestAssembler)).toThrow('Assembler already registered for TestFrom TestTo');
    });
});
