...
describe('ClassTransformerAssembler', () => {
    ...
    TestClassAssembler = tslib_1.__decorate([
        src_1.Assembler(TestDTO, TestEntity)
    ], TestClassAssembler);
    ...
    describe('with serializer', () => {
        ...
        TestSerializeDTO = tslib_1.__decorate([
            src_1.AssemblerSerializer(testDtoSerialize)
        ], TestSerializeDTO);
        let TestSerializeEntity = class TestSerializeEntity {
        };
        TestSerializeEntity = tslib_1.__decorate([
            src_1.AssemblerSerializer(testEntitySerialize)
        ], TestSerializeEntity);
        let TestSerializeClassAssembler = class TestSerializeClassAssembler extends src_1.ClassTransformerAssembler {
        };
        TestSerializeClassAssembler = tslib_1.__decorate([
            src_1.Assembler(TestSerializeDTO, TestSerializeEntity)
    ...
    describe('with deserializer', () => {
        ...
        TestDeserializeDTO = tslib_1.__decorate([
            src_1.AssemblerDeserializer(testDtoDeserialize)
        ], TestDeserializeDTO);
        let TestDeserializeEntity = class TestDeserializeEntity {
        };
        TestDeserializeEntity = tslib_1.__decorate([
            src_1.AssemblerDeserializer(testEntityDserialize)
        ...
        TestDesrializeClassAssembler = tslib_1.__decorate([
            src_1.Assembler(TestDeserializeDTO, TestDeserializeEntity)
