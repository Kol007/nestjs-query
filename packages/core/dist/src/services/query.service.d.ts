...
import { AggregateQuery, AggregateResponse, DeleteManyResponse, Filter, ModifyRelationOptions, Query, UpdateManyResponse, FindRelationOptions, FindByIdOptions, GetByIdOptions, UpdateOneOptions, DeleteOneOptions } from '../interfaces';
/**
