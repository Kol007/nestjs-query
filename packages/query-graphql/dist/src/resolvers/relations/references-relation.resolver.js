...
const ReferencesRelationsResolver = (DTOClass, references) => {
    return exports.ReferencesRelationMixin(DTOClass, references)(resolver_interface_1.BaseServiceResolver);
};
