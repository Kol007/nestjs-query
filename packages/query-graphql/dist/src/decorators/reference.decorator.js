...
function getReferenceDescriptors(DTOClass) {
    return core_1.getPrototypeChain(DTOClass).reduce((references, cls) => {
        var _a;
...
function convertReferencesToOpts(references, baseOpts) {
    return references.reduce((referenceOpts, r) => {
        const opts = common_1.mergeBaseResolverOpts({ ...r.relationOpts, DTO: r.relationTypeFunc(), keys: r.keys }, baseOpts !== null && baseOpts !== void 0 ? baseOpts : {});
